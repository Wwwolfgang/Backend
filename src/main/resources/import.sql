...
Insert into clientes (nombre,apellido,numero_doc,nacionalidad,telefono,email,create_at) values('Estela','Perez','5676678','paraguaya','0987654653','wwwolfgang469@fpuna.edu.py','2020-08-28');
Insert into clientes (nombre,apellido,numero_doc,nacionalidad,telefono,email,create_at) values('Roxana','Perez','5698678','paraguaya','0987654658','wwwolfgang469@fpuna.edu.py','2020-08-28');
Insert into clientes (nombre,apellido,numero_doc,nacionalidad,telefono,email,create_at) values('Sasha','Perez','5678378','paraguaya','0987654650','wwwolfgang469@fpuna.edu.py','2020-08-28');
